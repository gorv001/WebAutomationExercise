...
public class LoginTest extends BaseTest {
    ...
    @Test(enabled = true,priority = 0, dataProvider = "registrationData",dataProviderClass = TestData.class,retryAnalyzer = RetryAnalyzer.class)
    ...
    @Test(enabled = true,priority = 1, dataProvider = "registrationData",dataProviderClass = TestData.class,retryAnalyzer = RetryAnalyzer.class )
    ...
    @Test(enabled = true,priority = 2,dataProvider = "registrationData",dataProviderClass = TestData.class,retryAnalyzer = RetryAnalyzer.class )
    ...
    @Test(enabled = true,priority = 4,dataProvider = "registrationData",dataProviderClass = TestData.class,retryAnalyzer = RetryAnalyzer.class )
    ...
    @Test(enabled = true,priority = 5,dataProvider = "registrationData",dataProviderClass = TestData.class,retryAnalyzer = RetryAnalyzer.class )
